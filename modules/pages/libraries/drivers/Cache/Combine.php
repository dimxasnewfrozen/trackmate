...
/**
 * File combining-based Cache driver.
 *
 * $Id$
 *
 * @package    Cache
 ...
 */
class Cache_Combine_Driver implements Cache_Driver {
	...
	public function set($id, $data, $tags, $lifetime)
	{
		...
		$filename = $id.'~'.implode('+', $tags).'~'.$lifetime.'.'.$type;

		// Write the file, appending the sha1 signature to the beginning of the data
		$put = (bool) file_put_contents($this->directory.$filename, $data);
		
		// Return true/false whether file was written and the filename
